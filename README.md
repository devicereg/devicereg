...
Install [Docker](https://www.docker.com/) on your system. For Mac and Windows users: If you haven't worked with docker before I would recommend you to install the [Docker Toolbox](https://www.docker.com/products/docker-toolbox) because it contains all required tools such as VirtualBox.
...
Install [Docker Compose](http://docs.docker.com/compose/) on your system. If you have already installed the DockerToolbox in the previous step you can SKIP THIS STEP!
