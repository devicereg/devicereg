...
&{Mustermax}    Anrede=Herr  Vorname=Max  Nachname=Mustermann  Email=mustermax@htw-berlin.de  Sprache=Deutsch  Telefon=012 34 56 789
                Branchenfamilie=Elektro  Branchentyp=BT  Frimenname=Muster AG  Strasse=Musterstraße  Hausnummer=19  Postleitzahl=12345  Stadt=Berlin
                Land=Deutschland  Passwort=password  Geheimfrage=Geheim?  Antwort=Geheim!
